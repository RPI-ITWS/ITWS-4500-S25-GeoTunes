...
function run() {
    ...
    return React.createElement('header', {
        ...
        React.createElement('ul', { style: navListStyle },
            createNavItem('/music', 'Music'),
            createNavItem('/cultural-events', 'Cultural Events'),
            createNavItem('/cultural-information', 'Cultural Information')
        )
        ),
    ...
    function createNavItem(href, text) {
        return React.createElement('li', { style: navItemStyle },
        React.createElement('a', { href: href, style: navLinkStyle }, text)
        );
    }
